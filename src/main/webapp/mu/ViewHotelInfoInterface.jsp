        ...
        <div class="hotel-searchbar clearfix">
            <form class="form-inline" name="myForm" id = "alignCenterOne" method="post" action="${pageContext.request.contextPath}/HotelServlet?methods=updateRoomInfo&userId=<%=userId%>&hotelId=<%=hotel.getHotelId()%>" >
                ...
                <div class="form-group" style="margin-left: 5px;">
                    ...
                    <%}else{%>
                        <input type="text" name="ruzhu"  value="<%=ruzhu%>" class="layui-input" placeholder="请选择日期" id="oneInTime" style=" border-radius: 4px;height: 35px;width: 230px;">
                    <%}%>
                </div>
                <script>
                ...
                <div class="form-group" style="margin-left: 5px;">
                    ...
                    <%}else{%>
                        <input type="text" name="likai"  value="<%=likai%>" class="layui-input" placeholder="请选择日期" id="oneOutTime" style="width:230px;border-radius: 4px;height: 35px">
                    <%}%>
                </div>
                <script>
                    layui.use('laydate', function(){
